...
class ExampleTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # added connection between N1 and N2
...
#############
       ...
       # Create P2P connections will wait for a verack to make sure the connection is fully up
        ...
        self.log.info("status after the adding and before sync:\n")
        self.nodes_info()
        input("press a key to continue...")

        self.log.info("Wait for node1 to reach current tip (height " + str(final_height) + ") using RPC")
        self.nodes[1].waitforblockheight(final_height)
